...
export const ADMIN_OPERATIONS = [
  ...
  { id: "RES-01", domain: "reservations", method: "GET", path: "/admin/reservations", roles: ["admin", "reservationManager", "superAdmin"], successStatus: 200, response: "Reservation[]", query: ["status"], body: [], requestSource: "production-swagger", rolesSource: "local-controller" },
