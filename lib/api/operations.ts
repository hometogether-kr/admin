...
export const ADMIN_OPERATIONS = [
  ...
  { id: "USR-02", domain: "users", method: "GET", path: "/admin/users/{id}", roles: ["super"], successStatus: 200, response: "AdminUserDetail", query: [], body: [], requestSource: "not-applicable", rolesSource: "local-controller" },
  ...
  { id: "USR-08", domain: "users", method: "PATCH", path: "/admin/users/{id}", roles: ["super"], successStatus: 200, response: "AdminUserDetail", query: [], body: ["name", "email", "phone", "introduction?"], requestSource: "production-swagger", rolesSource: "local-controller" },
  { id: "USR-09", domain: "users", method: "DELETE", path: "/admin/users/{id}", roles: ["super"], successStatus: 204, response: "void", query: [], body: [], requestSource: "not-applicable", rolesSource: "local-controller" },
  ...
  { id: "ROM-12", domain: "rooms", method: "PATCH", path: "/admin/rooms/{id}", roles: ["room", "super"], successStatus: 200, response: "Room", query: [], body: ["monthlyRentKrw", "depositKrw", "maintenanceFeeKrw", "description?"], requestSource: "production-swagger", rolesSource: "local-controller" },
